...
"""This is a simplest possible naive implementation of the RIPCS (The rotational incremental pressure-correction schemes) solver.
...
def setup(u, q_, q_1, uc_comp, u_components, dt, v, U_AB, u_1, u_2, q_2,
    ...
    # Pressure update / the first term is different from IPCS solver
    # In the rotational form, pressure update is phi = p^(k+1) - p^(k) + nu * div(u_star)
